...
public class Viewpage2 extends JFrame implements ActionListener
{
...
//		i5=new ImageIcon("loc1.PNG");
		...
		i2=new ImageIcon("C:\\Users\\Om\\eclipse-workspace\\miniproject\\src\\test\\r2.PNG");
	...
	//	ta3.setOpaque(false);
		...
		l3.setBounds(40,10,130,130);	//photo lbls
		l4.setBounds(250,20,300,100);	//first_nm
		l5.setBounds(250,60,200,100);	//occupation
		l6.setBounds(250,200,150,30);	//contacts 
		l7.setBounds(230,240,70,40);		//msg
		l8.setBounds(230,280,70,40);		//phno
		l9.setBounds(230,320,70,40);		//add
		l10.setBounds(20,460,100,50);	//skills
		l11.setBounds( 20,200,150,30);	//abt me 20,200,150,30
		l12.setBounds(20,330,150,50);	//quali 
		l13.setBounds(250,450,150,30);	//work exp
		l14.setBounds(250,600,200,30);	//certi/project exp
		l15.setBounds(20,600,180,30);	//interested domains exp
				
		tf1.setBounds(300,240,130,40);	//msg tb
		tf2.setBounds(300,280,130,40);	//phno tb
		ta1.setBounds(300,320,130,80);	//add tb
		ta2.setBounds(20,520,150,50);	//skils tb
		ta3.setBounds(20,250,150,100);	//abt me tb 20,200,150,30
		ta4.setBounds(20,380,150,50);		//qualification tb  20,350,100,50
		ta5.setBounds(250,500,230,80);	//work exp tb
		ta6.setBounds(250,650,230,80);	//certi/project tb
		ta7.setBounds(20,650,150,50);	//interested domains tb
